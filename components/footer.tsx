...
export default function Footer() {
  return (
    <footer className="mt-auto bg-black border-t border-gray-800 py-16 px-4 sm:px-6 lg:px-8 w-full">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="font-serif font-bold text-lg mb-4 text-white">AMacademy – All About Music</h3>
            <p className="text-gray-300 text-sm mb-4">Piano Lessons & Music Academy in India</p>
            <a
          ...
          <div>
            ...
            <div className="space-y-3">
              <Link href="/" className="block text-gray-300 hover:text-white transition-colors duration-300 font-medium">
                Home
              </Link>
              <Link
                href="/testimonials"
              ...
              <Link href="/#gallery" className="block text-gray-300 hover:text-white transition-colors duration-300 font-medium">
                Gallery
              </Link>
            </div>
          </div>
